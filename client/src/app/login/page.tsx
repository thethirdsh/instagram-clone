...
const Login = () => {
  return (
    <div className="flex flex-col justify-center items-center bg-white text-black w-full h-screen">
      <div className="flex flex-col items-center border-[1px] border-gray-300 w-[350px] h-[409px]">
        ...
        <Link className="pt-8" href="/forgot-password"><p className="text-[#003366] text-sm font-light">Forgot password?</p></Link>
      </div>
    </div>
  )
}
