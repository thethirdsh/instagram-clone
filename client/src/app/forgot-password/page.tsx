  ...
  return (
    <div className="flex flex-col items-center bg-white w-full h-full">
      <div className="flex flex-col items-center py-12 lg:py-24">
        <div className="flex flex-col items-center rounded-sm border-[1px] border-gray-300 w-[335px] md:w-[388px] h-[534px]">
          ...
          <Link
            href="/signup"
            className="text-sm font-semibold pt-10 hover:opacity-45"
          >
            Create new account
          </Link>
        ...
        <div className="hidden lg:flex pt-[15%]">
          <Footer />
        </div>
      </div>
    </div>
